...
def test_ccd_matches_riskparityportfolio_readme_reference_example():
    ...
    # Sigma is reproduced from the riskParityPortfolio README setup using base R.
    # Expected weights are the README-reported output of riskParityPortfolio(Sigma).
    Sigma = np.array(
        [
            [
                0.4801188807777429,
